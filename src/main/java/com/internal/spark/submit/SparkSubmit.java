...
//
//       // prepare arguments to be passed to org.apache.spark.deploy.yarn.Client object
...
//
//           // comma separated list of local jars that want SparkContext.addJar to work with      
//           "--addJars",
