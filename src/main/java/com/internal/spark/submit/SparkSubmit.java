...
public class SparkSubmit {
  ...
  //
  // // prepare arguments to be passed to org.apache.spark.deploy.yarn.Client
  // object
  ...
  //
  // // comma separated list of local jars that want SparkContext.addJar to work
  // with
  // "--addJars",
  ...
  // // make sure that you create the following in SparkFriendRecommendation
  // program
  ...
  // Client client = new Client(cArgs);
  //
