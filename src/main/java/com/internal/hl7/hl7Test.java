...
public class hl7Test {
  ...
  public static void main(String[] args) { // throws HL7Exception {
    ...
    // OE|BLDG4|200202150930||ORU^R01|CNTRL-3456|P|2.4\r"
    // +
    // "PID|||555-44-4444||EVERYWOMAN^EVE^E^^^^L|JONES|19620320|F|||153 FERNWOOD
    // DR.^STATESVILLE^OH^35292||(206)334-5232|(206)752-1201||||AC555444444||67-A4335^OH^20030520\r"
    // +
    // "OBR|1|845439^GHH OE|1045813^GHH
    // LAB|15545^GLUCOSE|||200202150730|||||||||555-55-5555^PRIMARY^PATRICIA
    // P^^^^MD^^|||||||||F||||||444-44-4444^HIPPOCRATES^HOWARD H^^^^MD\r"
    // +
    // "OBX|1|SN|1554-5^GLUCOSE^POST 12H
    // CFST:MCNC:PT:SER/PLAS:QN||^182|mg/dl|70_105|H|||F\r";
    //
