...
//		String hlvRecord = "MSH|^~\\&|GHH LAB|ELAB-3|GHH OE|BLDG4|200202150930||ORU^R01|CNTRL-3456|P|2.4\r"
...
//		hl7Validator.isValid(hapiMsg, messageInfo);
	...
	private static String[] getVersion(String hl7Message) throws IndexOutOfBoundsException {
		...
		messageInfo[0] = StringUtils
					.splitByWholeSeparatorPreserveAllTokens(hl7Message, "|")[11].split("\\s")[0];
		
		messageInfo[1] = StringUtils
					.splitByWholeSeparatorPreserveAllTokens(hl7Message, "|")[8].split("\\s")[0];
