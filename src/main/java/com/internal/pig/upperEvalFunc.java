...
public class upperEvalFunc extends EvalFunc<String> {
   ...
   *         which can handle the inputs corresponding to the schema in the
   *         objects. Each FuncSpec should be constructed with a schema that
   *         describes the input for that implementation. For example, the sum
   *         function above would return two elements in its list:
   *         <ol>
